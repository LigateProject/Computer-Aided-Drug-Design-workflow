...
echo "CADD: Launching runAWHComplex " >>$LOGFILE
...
gmx mdrun -deffnm production_complex -cpnum -cpt 1 -cpo cpt_complex/state -pin on -ntmpi 1 -ntomp ${SLURM_JOB_CPUS_PER_NODE} -nb gpu -pme gpu -pmefft gpu -bonded gpu -update cpu
echo "CADD: run AWH complex finished " >> $LOGFILE
