...
echo "CADD: launching runAWHligand ">> $LOGFILE
...
gmx mdrun -deffnm production_ligand -cpnum -cpt 1 -cpo cpt_ligand/state -pin on -ntmpi 1 -ntomp ${SLURM_JOB_CPUS_PER_NODE} -nb gpu -pme gpu -pmefft gpu -bonded gpu -update cpu
echo "CADD: runAWHligand exiting ">> $LOGFILE
